 ...
 * @author potter
 */
public class ReliefAttBox implements IAttFitBoxChields{
    private final String idInst = "insTextField";
    private final String neiInst = "neiTextField";
    private final String sigInst = "sigmaTextField";
